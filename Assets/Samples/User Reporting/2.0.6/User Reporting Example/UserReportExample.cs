...
public class UserReportExample : MonoBehaviour
{
    ...
    public void CreateUserReport()
    {
        ...
        // Creating a new User Report will clear the previous ongoing report (if a previous one exists)
        ...
        string content = "{}";
        UserReportingService.Instance.AddAttachmentToReport("Sample Attachment JSON",
            "SampleAttachment.json", Encoding.UTF8.GetBytes(content), "application/json");
